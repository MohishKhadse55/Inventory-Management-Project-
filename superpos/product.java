...
public class product extends javax.swing.JFrame {
    ...
    // class to load the categorys in the combobox  
    /*  int the category combo box if user select the category in the combobox
        so instead of name id that id is added in the product table 
    */ 
    public class CategoryItem   
    {
        ...
        // overriding the by default to string methode in the class 
        public String toString()  // after instintiating this class it will return the string value 
        {
            return name ;
        }
    }
    ...
    // to load the brand item in the brand combobox
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txtbrand, javax.swing.GroupLayout.Alignment.TRAILING, 0, 187, Short.MAX_VALUE)
        ...
        // load the " category table "item in the category combobox
        ...
        try {
            Class.forName("com.mysql.jdbc.Driver");
             ...
             txtcat.removeAllItems();
                ...
                while (rs.next())
                {
                    // this above method by default runs the tostring method of the passed object ...
        ...
        // load the " Brand  table "item in the category combobox
        private void brand()
        {
        try {
            Class.forName("com.mysql.jdbc.Driver");
    ...
    private void txtstatusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtstatusActionPerformed
        ...
        // Add Button 
        // Inserting in the database and table 
